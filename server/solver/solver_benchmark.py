...
def main():
    ...
    #parser.add_argument('--mode', choices=['learn', 'happiness', 'balance', 'soft', 'performance'], default='balance', help="Usage types : learn or happiness or balance or soft or performance")
    parser.add_argument('--alpha1', type=float, default=None, help="Poids de l'affinité")
    parser.add_argument('--alpha2', type=float, default=None, help="Poids du matching thématique")
    parser.add_argument('--alpha3', type=float, default=None, help="Poids de la progression")
    parser.add_argument(
    '--dataset',
    type=str,
    ...
    if args.alpha1 is not None and args.alpha2 is not None and args.alpha3 is not None:
        weights = [args.alpha1, args.alpha2, args.alpha3]
    else:
        print("Erreur : Veuillez spécifier alpha1, alpha2 et alpha3.")
        sys.exit(1)
